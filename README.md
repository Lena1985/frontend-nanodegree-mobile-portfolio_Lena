...
To optimize views/pizza.html, you will need to modify vviews/js/main.js until your frames per second rate is 60 fps or higher. You will find instructive comments in main.js. 
...
* I have inlined the style.css file in the index.html and deleted the link to the css file and the file. 

* I moved the "Google Analytics script" to the end of the HTML File
...
* I minified the bootsrap-grid.css
